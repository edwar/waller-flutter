  ...
  Widget build(BuildContext context) {
    final _buildTextInfo = Padding(
      ...
      child: Text.rich(
        TextSpan(
            text:
                'You can now add gift card with a specific balance into wallet. When the card hits \$0.00 it will automatically dissapear. Want to know if you gift card will link? ',
