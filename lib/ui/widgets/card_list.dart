...
class CardFrontList extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final _cardLastNumber = Padding(
      ...
      child: Text(cardModel.cardNumber.substring(12),
        ...
        children: <Widget>[
          Column(
            children: <Widget>[
              ...
              Text('Thru', style: TextStyle(color: Colors.white, fontSize: 7.0))
            ],
          ),
          SizedBox(
            width: 5.0,
          ),
          Text('${cardModel.cardMonth}/${cardModel.cardYear.substring(2)}',
